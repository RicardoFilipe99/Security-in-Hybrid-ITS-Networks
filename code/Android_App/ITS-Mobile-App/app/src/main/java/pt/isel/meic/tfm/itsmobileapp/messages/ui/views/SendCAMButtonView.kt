...
fun SendCAMButtonView(
    ...
    //Log.v(TAG_MESSAGES_UI, "SendCAMButtonView composed")
    ...
    Button(
        ...
        val text = stringResource(id = R.string.activity_main_send_cam_button_text)
        Text(text = text)
    }
}
...
// Preview CAM button enabled
@Preview(showBackground = true)
@Composable
fun PreviewSendCAMButtonViewEnabled() {
    ITSMobileAppTheme {
        SendCAMButtonView(
            enabled = true,
            onClick = {},
...
// Preview CAM button disabled
@Preview(showBackground = true)
@Composable
fun PreviewSendCAMButtonViewDisabled() {
    ITSMobileAppTheme {
        SendCAMButtonView(
            enabled = false,
            onClick = {},
